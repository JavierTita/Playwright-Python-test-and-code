...
def test_removecart(logged_page):
   logged_page.locator("#add-to-cart-sauce-labs-backpack").click()
   logged_page.locator("#add-to-cart-sauce-labs-bike-light").click()
   logged_page.locator("#add-to-cart-sauce-labs-bolt-t-shirt").click()
   logged_page.locator("#add-to-cart-sauce-labs-fleece-jacket").click()
   logged_page.locator("#add-to-cart-sauce-labs-onesie").click() 
   logged_page.locator("[data-test='add-to-cart-test.allthethings()-t-shirt-(red)']").click()
   logged_page.locator("#remove-sauce-labs-backpack").click()
   logged_page.locator("#remove-sauce-labs-bike-light").click()
   logged_page.locator("#remove-sauce-labs-bolt-t-shirt").click()
   logged_page.locator("#remove-sauce-labs-fleece-jacket").click()
   logged_page.locator("#remove-sauce-labs-onesie").click() 
   logged_page.locator("[data-test='remove-test.allthethings()-t-shirt-(red)']").click()
   expect(logged_page.locator("[data-test='shopping-cart-badge']")).not_to_be_visible()
